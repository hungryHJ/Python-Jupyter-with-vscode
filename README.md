...
경로에 영어 외의 글자가 있다면 설치가 안될 수 있다. 이전으로 돌아가 _"Just Me"_ 가  아닌 _"All Users"_ 로 설치하면 된다.

![alt](img/이미지%20029.png)  
 _All Users_ 로 설치하면, 대부분의 기능을 **관리자 권한으로 실행** 해야하므로 추천하지 않는다.  
...
**주의!: 반드시 가상환경이 활성화가 먼저 되어야함. 2.2참고**
